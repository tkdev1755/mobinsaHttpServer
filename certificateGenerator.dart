...
String certPath = Platform.isMacOS ? "${getExecutableAbsolutePath()}/../files/cert.pem": "cert.pem";
String keyPath = Platform.isMacOS ? "${getExecutableAbsolutePath()}/../files/key.pem": "key.pem";
